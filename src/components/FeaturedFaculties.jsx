        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="text-center mb-12">
                ...
                <p className="mt-3 text-sm sm:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
                    Explore our most popular and highly rated sports facilities for football, cricket, badminton, swimming, and more.
                </p>
            </div>
            ...
            <div className="flex justify-center items-center mt-12">
                <Button
                    className="bg-gradient-to-r from-sky-500 to-blue-700 text-white font-semibold rounded-2xl px-7 h-12 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_rgba(59,130,246,0.4)] active:scale-95"
                >
                    <Link
                        href="/all-facilities"
